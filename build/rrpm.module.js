...
var PopupMenu$1 = function (_Component) {
  ...
  function PopupMenu$$1(props) {
    classCallCheck(this, PopupMenu$$1);

    var _this = possibleConstructorReturn(this, (PopupMenu$$1.__proto__ || Object.getPrototypeOf(PopupMenu$$1)).call(this, props));
...
PopupMenu$1.defaultProps = {
  width: 200,
  height: 'auto'
};
PopupMenu$1.childContextTypes = {
...
var style = { "PopupTable": "PopupTable_PopupTable__3fGcX", "item": "PopupTable_item__1j75h", "placeholder": "PopupTable_placeholder__CKltF" };
...
var getSize = function getSize(element) {
  ...
  return new Promise(function (resolve) {
    render(element, elementParent, function () {
      resolve({
    ...
    value: function render$$1() {
      ...
      return React.createElement(
        ...
        children.map(function (child, i) {
          return React.createElement(
            'div',
            { key: i, className: i === children.length - 1 && items > 0 ? style.placeholder : style.item },
            child
          );
        })
      );
